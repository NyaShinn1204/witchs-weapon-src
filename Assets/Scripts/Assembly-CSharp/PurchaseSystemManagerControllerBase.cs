public abstract class PurchaseSystemManagerControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializePurchaseSystemManager(PurchaseSystemManagerViewModel purchaseSystemManager);
	...
	public virtual PurchaseSystemManagerViewModel CreatePurchaseSystemManager()
	{
		return null;
	}
	...
	public virtual void BuyGold(PurchaseSystemManagerViewModel purchaseSystemManager)
	{
	}

	public virtual void BuyVit(PurchaseSystemManagerViewModel purchaseSystemManager)
	{
	}
}
