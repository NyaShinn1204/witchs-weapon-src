public abstract class PackageItemControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public PackageManagerController PackageManagerController { get; set; }

	public abstract void InitializePackageItem(PackageItemViewModel packageItem);
	...
	public virtual PackageItemViewModel CreatePackageItem()
	{
		return null;
	}
