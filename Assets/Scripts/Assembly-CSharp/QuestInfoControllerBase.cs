public abstract class QuestInfoControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public QuestSystemManagerController QuestSystemManagerController { get; set; }

	public abstract void InitializeQuestInfo(QuestInfoViewModel questInfo);
	...
	public virtual QuestInfoViewModel CreateQuestInfo()
	{
		return null;
	}
