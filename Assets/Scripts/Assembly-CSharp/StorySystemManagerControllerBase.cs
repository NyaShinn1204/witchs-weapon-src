public abstract class StorySystemManagerControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeStorySystemManager(StorySystemManagerViewModel storySystemManager);
	...
	public virtual StorySystemManagerViewModel CreateStorySystemManager()
	{
		return null;
	}
	...
	public virtual void NoticeStoryGroupUnlock(StorySystemManagerViewModel storySystemManager, long arg)
	{
	}

	public virtual void NoticeStorynlock(StorySystemManagerViewModel storySystemManager, long arg)
	{
	}

	public virtual void NoticeStoryCanUnlock(StorySystemManagerViewModel storySystemManager, long arg)
	{
	}

	public virtual void BuyStory(StorySystemManagerViewModel storySystemManager, long arg)
	{
	}

	public virtual void FinishBuyStory(StorySystemManagerViewModel storySystemManager)
	{
	}

	public virtual void BuyStoryByItem(StorySystemManagerViewModel storySystemManager, long arg)
	{
	}

	public virtual void FinishBuyStoryByItem(StorySystemManagerViewModel storySystemManager)
	{
	}
}
