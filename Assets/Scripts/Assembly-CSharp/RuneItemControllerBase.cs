public abstract class RuneItemControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public RuneManagerController RuneManagerController { get; set; }

	public abstract void InitializeRuneItem(RuneItemViewModel runeItem);
	...
	public virtual RuneItemViewModel CreateRuneItem()
	{
		return null;
	}
