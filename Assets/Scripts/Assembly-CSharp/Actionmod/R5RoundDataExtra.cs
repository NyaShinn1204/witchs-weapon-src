...
namespace Actionmod
{
	public sealed class R5RoundDataExtra : IMessage<R5RoundDataExtra>, IMessage, IEquatable<R5RoundDataExtra>, IDeepCloneable<R5RoundDataExtra>
	{
		private static readonly MessageParser<R5RoundDataExtra> _parser;
		...
		[DebuggerNonUserCode]
		public static MessageParser<R5RoundDataExtra> Parser
		{
			get
			{
				return null;
		...
		[DebuggerNonUserCode]
		public R5RoundDataExtra()
		{
		}

		[DebuggerNonUserCode]
		public R5RoundDataExtra(R5RoundDataExtra other)
		{
		}

		[DebuggerNonUserCode]
		public R5RoundDataExtra Clone()
		{
			return null;
		}
		...
		[DebuggerNonUserCode]
		public bool Equals(R5RoundDataExtra other)
		{
			return false;
		}
		...
		[DebuggerNonUserCode]
		public void MergeFrom(R5RoundDataExtra other)
		{
		}
