...
namespace Actionmod
{
	public sealed class R2DataExtra : IMessage<R2DataExtra>, IMessage, IEquatable<R2DataExtra>, IDeepCloneable<R2DataExtra>
	{
		private static readonly MessageParser<R2DataExtra> _parser;
		...
		[DebuggerNonUserCode]
		public static MessageParser<R2DataExtra> Parser
		{
			get
			{
				return null;
		...
		[DebuggerNonUserCode]
		public R2DataExtra(R2DataExtra other)
		{
		}

		[DebuggerNonUserCode]
		public R2DataExtra Clone()
		{
			return null;
		}
		...
		[DebuggerNonUserCode]
		public bool Equals(R2DataExtra other)
		{
			return false;
		}
		...
		[DebuggerNonUserCode]
		public void MergeFrom(R2DataExtra other)
		{
		}
