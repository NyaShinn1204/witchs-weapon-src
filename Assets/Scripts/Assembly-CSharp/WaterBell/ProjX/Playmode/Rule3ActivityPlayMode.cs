...
{
	public class Rule3ActivityPlayMode : BasicActivityPlayMode
	{
		...
		public Rule3ActivityPlayMode(long instID, MngrCollection mngrc)
			: base(0L, null)
		{
		}
		...
		public bool isBuffLevel(long levelID)
		{
			return false;
		}
