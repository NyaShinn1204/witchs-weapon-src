...
{
	public class GetAwardsPanel : UIPanelSingle
	{
		public static GetAwardsPanel current;

		private const string PREFAB_PATH = "UI/Prefab/GetAwardsPanel";
		...
		public static GetAwardsPanel GetInstance()
		{
			return null;
		}
		...
		public void ShowOpenChestFallItem(long itemID, long targetItemID, int num = 1)
		{
		}
