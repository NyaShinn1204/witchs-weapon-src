public abstract class ServantWeaponExpItemControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public CurrentServantWeaponInfoController CurrentServantWeaponInfoController { get; set; }

	public abstract void InitializeServantWeaponExpItem(ServantWeaponExpItemViewModel servantWeaponExpItem);
	...
	public virtual ServantWeaponExpItemViewModel CreateServantWeaponExpItem()
	{
		return null;
	}
