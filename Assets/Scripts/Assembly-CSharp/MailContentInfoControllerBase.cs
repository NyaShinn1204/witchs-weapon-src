public abstract class MailContentInfoControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public MailManagerController MailManagerController { get; set; }

	public abstract void InitializeMailContentInfo(MailContentInfoViewModel mailContentInfo);
	...
	public virtual MailContentInfoViewModel CreateMailContentInfo()
	{
		return null;
	}
