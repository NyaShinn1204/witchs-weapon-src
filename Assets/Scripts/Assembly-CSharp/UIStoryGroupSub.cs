...
public class UIStoryGroupSub : IUIStoryGroup
{
	...
	public UIStoryGroupSub(List<TypeCsvStoryGroup> ringsMain, GameObject objRing, GameObject objIcon, UIScrollView sScrollView, UIScrollBar sScrollBar, UIWidget sSelectView, UISprite sSelectViewBG)
	{
	}
