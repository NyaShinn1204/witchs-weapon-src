public abstract class QuestSystemManagerControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public QuestInfoController QuestInfoController { get; set; }

	public abstract void InitializeQuestSystemManager(QuestSystemManagerViewModel questSystemManager);
	...
	public virtual QuestSystemManagerViewModel CreateQuestSystemManager()
	{
		return null;
	}
	...
	public virtual void FinishiQuest(QuestSystemManagerViewModel questSystemManager, long arg)
	{
	}

	public virtual void OpenGuide(QuestSystemManagerViewModel questSystemManager, long arg)
	{
	}

	public virtual void AfterFinishQuest(QuestSystemManagerViewModel questSystemManager)
	{
	}

	public virtual void ReceiveAllQuest(QuestSystemManagerViewModel questSystemManager, int arg)
	{
	}

	public virtual void FinishReceiveAllQuest(QuestSystemManagerViewModel questSystemManager)
	{
	}
}
