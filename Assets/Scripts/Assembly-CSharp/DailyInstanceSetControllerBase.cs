public abstract class DailyInstanceSetControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public ProgressSystemManagerController ProgressSystemManagerController { get; set; }

	[Inject]
	public DailyInstanceController DailyInstanceController { get; set; }

	public abstract void InitializeDailyInstanceSet(DailyInstanceSetViewModel dailyInstanceSet);
	...
	public virtual DailyInstanceSetViewModel CreateDailyInstanceSet()
	{
		return null;
	}
