...
public class System_Collections_ObjectModel_Collection_WaterBell_ProjX_Data_Entity_ObservableSingleItemWrap
{
	public static void Register(LuaState L)
	{
	}

	private static int _CreateSystem_Collections_ObjectModel_Collection_WaterBell_ProjX_Data_Entity_ObservableSingleItem(IntPtr L)
	{
		return 0;
	}
