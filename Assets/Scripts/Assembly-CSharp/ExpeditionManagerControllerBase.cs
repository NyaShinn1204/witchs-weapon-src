public abstract class ExpeditionManagerControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeExpeditionManager(ExpeditionManagerViewModel expeditionManager);
	...
	public virtual ExpeditionManagerViewModel CreateExpeditionManager()
	{
		return null;
	}
	...
	public virtual void ResetExpedition(ExpeditionManagerViewModel expeditionManager)
	{
	}

	public virtual void CommitExpeditionServant(ExpeditionManagerViewModel expeditionManager, CommitExpeditionServant arg)
	{
	}

	public virtual void ReceiveChest(ExpeditionManagerViewModel expeditionManager)
	{
	}

	public virtual void RefreshExpedition(ExpeditionManagerViewModel expeditionManager)
	{
	}

	public virtual void FinishReset(ExpeditionManagerViewModel expeditionManager)
	{
	}

	public virtual void FinishLoot(ExpeditionManagerViewModel expeditionManager)
	{
	}

	public virtual void GetRank(ExpeditionManagerViewModel expeditionManager, int arg)
	{
	}

	public virtual void FinishGetRank(ExpeditionManagerViewModel expeditionManager)
	{
	}
}
