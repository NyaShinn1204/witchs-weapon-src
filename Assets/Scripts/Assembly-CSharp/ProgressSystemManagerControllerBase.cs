public abstract class ProgressSystemManagerControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public ProgressChapterController ProgressChapterController { get; set; }

	[Inject]
	public DailyInstanceSetController DailyInstanceSetController { get; set; }

	public abstract void InitializeProgressSystemManager(ProgressSystemManagerViewModel progressSystemManager);
	...
	public virtual ProgressSystemManagerViewModel CreateProgressSystemManager()
	{
		return null;
	}
	...
	public virtual void SelectlLevelByID(ProgressSystemManagerViewModel progressSystemManager, long arg)
	{
	}

	public virtual void ResetBattleCount(ProgressSystemManagerViewModel progressSystemManager)
	{
	}

	public virtual void Sweep(ProgressSystemManagerViewModel progressSystemManager, SweepArgu arg)
	{
	}

	public virtual void SweepFinish(ProgressSystemManagerViewModel progressSystemManager)
	{
	}

	public virtual void ResetBattleCountByID(ProgressSystemManagerViewModel progressSystemManager, long arg)
	{
	}

	public virtual void SetTargetWeapon(ProgressSystemManagerViewModel progressSystemManager, long arg)
	{
	}
}
