public abstract class DailyInstanceControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeDailyInstance(DailyInstanceViewModel dailyInstance);
	...
	public virtual DailyInstanceViewModel CreateDailyInstance()
	{
		return null;
	}
