public abstract class UserAchievementManagerControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeUserAchievementManager(UserAchievementManagerViewModel userAchievementManager);
	...
	public virtual UserAchievementManagerViewModel CreateUserAchievementManager()
	{
		return null;
	}
	...
	public virtual void GetRewardChange(UserAchievementManagerViewModel userAchievementManager, long arg)
	{
	}

	public virtual void RefreshAchieve(UserAchievementManagerViewModel userAchievementManager)
	{
	}
}
