public abstract class NewExternalElementGraphControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeNewExternalElementGraph(NewExternalElementGraphViewModel newExternalElementGraph);
	...
	public virtual NewExternalElementGraphViewModel CreateNewExternalElementGraph()
	{
		return null;
	}
