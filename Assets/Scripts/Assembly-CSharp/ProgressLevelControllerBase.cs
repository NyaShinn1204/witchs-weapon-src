public abstract class ProgressLevelControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeProgressLevel(ProgressLevelViewModel progressLevel);
	...
	public virtual ProgressLevelViewModel CreateProgressLevel()
	{
		return null;
	}
