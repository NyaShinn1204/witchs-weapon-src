public abstract class FashionSystemManagerControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeFashionSystemManager(FashionSystemManagerViewModel fashionSystemManager);
	...
	public virtual FashionSystemManagerViewModel CreateFashionSystemManager()
	{
		return null;
	}
	...
	public virtual void SelectFashion(FashionSystemManagerViewModel fashionSystemManager, long arg)
	{
	}

	public virtual void BuyFashion(FashionSystemManagerViewModel fashionSystemManager, long arg)
	{
	}

	public virtual void RefreshFashion(FashionSystemManagerViewModel fashionSystemManager)
	{
	}

	public virtual void FinishRefresh(FashionSystemManagerViewModel fashionSystemManager)
	{
	}
}
