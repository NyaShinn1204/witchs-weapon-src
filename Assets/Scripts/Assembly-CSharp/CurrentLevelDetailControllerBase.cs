public abstract class CurrentLevelDetailControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeCurrentLevelDetail(CurrentLevelDetailViewModel currentLevelDetail);
	...
	public virtual CurrentLevelDetailViewModel CreateCurrentLevelDetail()
	{
		return null;
	}
