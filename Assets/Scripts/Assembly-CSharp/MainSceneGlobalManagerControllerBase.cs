public abstract class MainSceneGlobalManagerControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeMainSceneGlobalManager(MainSceneGlobalManagerViewModel mainSceneGlobalManager);
	...
	public virtual MainSceneGlobalManagerViewModel CreateMainSceneGlobalManager()
	{
		return null;
	}
	...
	public virtual void ToBattle(MainSceneGlobalManagerViewModel mainSceneGlobalManager)
	{
	}
}
