public abstract class AchievementCompleteControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public AchievementSystemManagerController AchievementSystemManagerController { get; set; }

	public abstract void InitializeAchievementComplete(AchievementCompleteViewModel achievementComplete);
	...
	public virtual AchievementCompleteViewModel CreateAchievementComplete()
	{
		return null;
	}
