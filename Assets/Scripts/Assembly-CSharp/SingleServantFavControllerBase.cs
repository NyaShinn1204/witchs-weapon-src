public abstract class SingleServantFavControllerBase : Controller
{
	[Inject]
	...
	public abstract void InitializeSingleServantFav(SingleServantFavViewModel singleServantFav);
	...
	public virtual SingleServantFavViewModel CreateSingleServantFav()
	{
		return null;
	}
