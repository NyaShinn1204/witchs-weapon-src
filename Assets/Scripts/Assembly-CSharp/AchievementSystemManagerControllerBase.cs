public abstract class AchievementSystemManagerControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public AchievementInProgressController AchievementInProgressController { get; set; }

	[Inject]
	public AchievementCompleteController AchievementCompleteController { get; set; }

	public abstract void InitializeAchievementSystemManager(AchievementSystemManagerViewModel achievementSystemManager);
	...
	public virtual AchievementSystemManagerViewModel CreateAchievementSystemManager()
	{
		return null;
	}
	...
	public virtual void GetReward(AchievementSystemManagerViewModel achievementSystemManager, long arg)
	{
	}

	public virtual void FinishGetReward(AchievementSystemManagerViewModel achievementSystemManager)
	{
	}
}
