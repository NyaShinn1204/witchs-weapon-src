public abstract class ProgressChapterControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public ProgressLevelController ProgressLevelController { get; set; }

	public abstract void InitializeProgressChapter(ProgressChapterViewModel progressChapter);
	...
	public virtual ProgressChapterViewModel CreateProgressChapter()
	{
		return null;
	}
