public abstract class CurrentServantWeaponInfoControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public ServantWeaponExpItemController ServantWeaponExpItemController { get; set; }

	public abstract void InitializeCurrentServantWeaponInfo(CurrentServantWeaponInfoViewModel currentServantWeaponInfo);
	...
	public virtual CurrentServantWeaponInfoViewModel CreateCurrentServantWeaponInfo()
	{
		return null;
	}
	...
	public virtual void SelectWeapon(CurrentServantWeaponInfoViewModel currentServantWeaponInfo, long arg)
	{
	}

	public virtual void AddWeapon(CurrentServantWeaponInfoViewModel currentServantWeaponInfo)
	{
	}

	public virtual void ChangeWeapon(CurrentServantWeaponInfoViewModel currentServantWeaponInfo, long arg)
	{
	}

	public virtual void AddWeaponExp(CurrentServantWeaponInfoViewModel currentServantWeaponInfo, string arg)
	{
	}

	public virtual void TestFakeAddExp(CurrentServantWeaponInfoViewModel currentServantWeaponInfo, int arg)
	{
	}

	public virtual void SubmitAddWeaponExp(CurrentServantWeaponInfoViewModel currentServantWeaponInfo, UseItemArgus arg)
	{
	}

	public virtual void PromoteWeaponSpell(CurrentServantWeaponInfoViewModel currentServantWeaponInfo)
	{
	}

	public virtual void ComposeWeapon(CurrentServantWeaponInfoViewModel currentServantWeaponInfo, long arg)
	{
	}

	public virtual void SwitchSkin(CurrentServantWeaponInfoViewModel currentServantWeaponInfo, int arg)
	{
	}
}
