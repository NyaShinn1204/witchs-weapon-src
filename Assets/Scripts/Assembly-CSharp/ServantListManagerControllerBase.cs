public abstract class ServantListManagerControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public ServantListItemController ServantListItemController { get; set; }

	public abstract void InitializeServantListManager(ServantListManagerViewModel servantListManager);
	...
	public virtual ServantListManagerViewModel CreateServantListManager()
	{
		return null;
	}
	...
	public virtual void TestAddServant(ServantListManagerViewModel servantListManager, long arg)
	{
	}

	public virtual void TestChangeServant(ServantListManagerViewModel servantListManager, string arg)
	{
	}

	public virtual void SelectSvFoDevelop(ServantListManagerViewModel servantListManager, long arg)
	{
	}

	public virtual void SelectServantForBattle(ServantListManagerViewModel servantListManager, string arg)
	{
	}

	public virtual void ComposeSv(ServantListManagerViewModel servantListManager, long arg)
	{
	}
}
