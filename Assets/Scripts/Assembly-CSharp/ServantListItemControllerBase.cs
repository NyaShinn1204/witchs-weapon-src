public abstract class ServantListItemControllerBase : Controller
{
	[Inject]
	...
	[Inject]
	public ServantListManagerController ServantListManagerController { get; set; }

	public abstract void InitializeServantListItem(ServantListItemViewModel servantListItem);
	...
	public virtual ServantListItemViewModel CreateServantListItem()
	{
		return null;
	}
